...
export class AdminLayoutComponent implements OnInit {
  ...
  private iconDocumentosSvg = `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="12" y1="18" x2="12" y2="12"/><line x1="9" y1="15" x2="15" y2="15"/></svg>`;
  private iconReportesSvg = `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/></svg>`;
  ...
  ngOnInit(): void {
    ...
    this.menuItems = [
      ...
      { label: 'Documentos',    icon: this.sanitizer.bypassSecurityTrustHtml(this.iconDocumentosSvg),    route: '/admin/documentos' },
      { label: 'Reportes',      icon: this.sanitizer.bypassSecurityTrustHtml(this.iconReportesSvg),      route: '/admin/reportes' },
    ];
  }
}
